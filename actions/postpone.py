...
def postpone(bot, update, args):
    ...
    try:
        ...
        bot.send_message(chat_id=update.message.chat_id, text=f"Sorry, there is no remind to postpone😔")
...
def postpone_30(bot, user_chat_id):
    ...
    try:
        ...
        bot.send_message(chat_id=user_chat_id, text=f"Sorry, there is no remind to postpone😔")
